...
# Compatibility re-exports. Keep these imports last so history and streaming
# can depend on the foundational request, response, and part types above.
from dspy.core.history import LMHistoryEntry  # noqa: E402,F401
from dspy.core.streaming import (  # noqa: E402,F401
    AsyncLMStream,
    LMAnyDelta,
    LMAudioDelta,
    LMCitationDelta,
