...
def _dump_lm_state(lm: BaseLM) -> dict[str, Any]:
...
def _load_lm_from_state(lm_state: dict[str, Any]) -> BaseLM:
    """Reconstruct a legacy or custom BaseLM from serialized state.
